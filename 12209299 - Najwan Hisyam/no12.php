...
<body>
    <div class="form-container">
        <form action="" method="post" class="form-style-3">
            <h2>Input Waktu</h2>
            <label for="field1"><span>jam <span class="required">*</span></span><input type="number" class="input-field" name="mm" value="" /></label>
            <label for="field2"><span>menit <span class="required">*</span></span><input type="number" class="input-field" name="hh" value="" /></label>
