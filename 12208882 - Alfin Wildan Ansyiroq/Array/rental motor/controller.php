...
class DataMotor {
    ...
    private $hargaAerox;
    private $hargaVario;
    private $listVIP = ['Alfin', 'Malik', 'Syamil', 'Wildan'];
    ...
    class Pembelian extends DataMotor {
        ...
        if (in_array($this->getListName(), $this->getListVIP())){
            ...
            echo '<p>Harga sewa motor per Hari: <strong>Rp ' . number_format($dataHargaMotor[$this->jenisYangDipilih], 0, ',', '.') . '</strong></p>';
            ...
            echo '<p>Harga sewa motor per Hari: <strong>Rp ' . number_format($dataHargaMotor[$this->jenisYangDipilih], 0, ',', '.') . '</strong></p>';
            echo '<p>Lama Peminjaman (Hari): <strong>' . $this->lamaWaktu . '</strong></p>';
            echo '<p>Anda Tidak Mendapatkan Diskon Karena Bukan Member VIP</p>';
