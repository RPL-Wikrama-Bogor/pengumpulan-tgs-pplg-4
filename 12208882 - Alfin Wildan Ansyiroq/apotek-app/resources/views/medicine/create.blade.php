...
@section('content')
    <form action="{{route('medicine.store')}}" method="post" class=" card mt-5 p-4 bg-light ">

        {{-- supaya bisa masuk ke dalam database menggunakan token   --}}
        @csrf
        ...
        {{-- jika berhasil muculkan notifnya --}}
