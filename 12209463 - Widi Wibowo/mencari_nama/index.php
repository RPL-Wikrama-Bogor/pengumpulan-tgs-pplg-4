...
<form method="post">
    ...
    <input type="submit" value="Cari" id="submitButton" disabled>
</form>


<script>
    // Menyimpan referensi ke elemen-elemen yang diperlukan
    const cariNamaInput = document.getElementById("cari_nama");
    const submitButton = document.getElementById("submitButton");

    // Menambahkan event listener ke input nama
    cariNamaInput.addEventListener("input", function () {
        // Mengaktifkan atau menonaktifkan tombol "Submit" berdasarkan apakah input nama telah diisi
        if (cariNamaInput.value.trim() !== "") {
