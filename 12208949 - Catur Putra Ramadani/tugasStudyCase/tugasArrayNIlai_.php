...
echo "Urutan Nilai Terbesar: " . implode(", ", $nilaiTerbesar) . "<br><hr>";

$rataRata = array_sum($nilaiSaya) / count($nilaiSaya);
echo "Rata-rata Nilai: " . round($rataRata) . "<br><hr>";
