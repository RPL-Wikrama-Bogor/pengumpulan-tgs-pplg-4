...
class BarangModel {
    ...
    public function tambahBarang($data){
        ...
        $query = "INSERT INTO meminjam (nama_peminjam, jenis_barang, no_barang, tgl_pinjam, tgl_kembali, status) VALUES(:nama_peminjam, :jenis_barang, :no_barang, :tgl_pinjam, :tgl_pinjam,  :status)";
        $this->db->query($query);
    ...
    public function updateDataBarang($data)
    {
        ...
        $query = "UPDATE meminjam SET nama_peminjam=:nama_peminjam, jenis_barang=:jenis_barang, no_barang=:no_barang, tgl_pinjam=:tgl_pinjam, tgl_kembali=:tgl_kembali, status=:status WHERE id=:id";
            $this->db->query($query);
    ...
    public function cariBarang(){
        ...
        $this->db->query("SELECT * FROM meminjam WHERE nama_peminjam LIKE :keyword OR jenis_barang LIKE :keyword");
