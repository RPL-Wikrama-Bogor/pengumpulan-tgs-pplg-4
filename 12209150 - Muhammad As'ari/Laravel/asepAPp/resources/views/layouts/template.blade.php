                    ...
                    <ul class="nav nav-pills flex-column mt-4">
                        <li class="nav-item">
                            <a href="dashboard" class="nav-link">
                                </i><span class="fs-5 d-none d-sm-inline">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                </i><span class="fs-5 d-none d-sm-inline">Data User</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                </i><span class="fs-5 d-none d-sm-inline">Data Surat</span>
                            </a>
                        </li>
                    </ul>
                </div>
