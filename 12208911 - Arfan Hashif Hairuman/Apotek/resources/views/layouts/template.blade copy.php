                ...
                <ul class="navbar-nav">
                  ...
                  @if (Auth::check())
                    @if (Auth::user()->role == "admin")
                        ...
                        <li class="nav-item">
                          <a href="{{ route('user.index') }}" aria-current="page" class="nav-link">Kelola Akun</a>
                        </li>
                        @else
                        <li class="nav-item">
                          <a href="{{ route('kasir.order.index') }}" aria-current="page" class="nav-link">Pembelian</a>
                        </li>
                    @endif
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('user.home') }}">Pengelolaan Akun</a>
                  </li>
                  @if (Auth::check())
                  <li class="nav-item">
                    <a href="{{ route('logout') }}" class="nav-link">Logout</a>
