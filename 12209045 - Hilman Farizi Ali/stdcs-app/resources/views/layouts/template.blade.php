                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="pages1" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="{{ route('user.home') }}" class="sidebar-link mx-4"><i class="ri-table-fill"></i> Data Staff Tata Usaha</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('userg.home') }}" class="sidebar-link mx-4"><i class="ri-table-fill"></i> Data Guru</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        ...
                        <ul id="pages2" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="{{ route('lettertype.home') }}" class="sidebar-link mx-4"><i class="ri-table-fill"></i>Data Klasifikasi Surat</a>
                            </li>
                            <li class="sidebar-item">
