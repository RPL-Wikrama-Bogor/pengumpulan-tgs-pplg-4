<div class="container">
    <h3 class="mb-3">Borrowing Edit : <?= $data['barang']['nama_peminjam'] ?></h3>
    <form action="<?= BASE_URL; ?>/barang/updateBarang" method="post">
        <div class="claas-body">
            ...
            <div class="form-group mb-3">
                <label for="nama_peminjam">Borrower's Name</label>
            ...
            <div class="form-group mb-3">
                <label for="tgl_kembali">Return Date</label>
                <input type="datetime-local" class="form-control" id="tgl_kembali" name="tgl_kembali" value="<?= $data['barang']['tgl_kembali'] ?>">
            </div>
        </div>
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">Submit</button>
            <a href="<?= BASE_URL ?>/barang/index"><button type="button" class="btn btn-danger">Cancelled</button></a>
        </div>
    </form>
</div>