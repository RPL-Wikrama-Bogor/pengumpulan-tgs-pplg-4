...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Misalnya, Anda dapat menghitung total harga pesanan makanan dan minuman
    // atau melakukan tindakan lain sesuai kebutuhan aplikasi Anda

    // Contoh sederhana: menghitung total harga
    $totalMakanan = 0;
    $totalMinuman = 0;
    ...
    // Menerapkan diskon 10% jika jumlah total item (makanan dan minuman) lebih dari 5
