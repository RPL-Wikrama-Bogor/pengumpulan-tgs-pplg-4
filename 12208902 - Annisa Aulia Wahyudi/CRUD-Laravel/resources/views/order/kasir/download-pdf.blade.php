...
<body>     
    <div id="receipt">
        ...
        <div id="bot">
            ...
            <div class="legalcopy">
                <p class="legal"><strong>Terima kasih atas pembelian anda!</strong> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditate, quis facere. Deleniti, 
                    sapiente odio? Deserunt possimus vel maxime, ab eos cumque dolorum beatae atque necessitatibus, esse nisi earum magni ex.
                </p>
            </div>
        </div>
    </div>
